          ...
          <div class="box-header with-border">
            ...
            <label>No SKU</label>
             ...
             <option value="">Choose SKU</option>
              ...
              <div class="col-md-6">
              <label>40FT</label>
              <input class="form-control" name="FT40" type="number" id="price"  readonly>
              </div>
              <div class="col-md-6">
              <label>20FT</label>
              <input class="form-control" name="FT20" type="number" id="prices" readonly>
              </div>
              <div class="col-md-6">
              <label>LCL AF</label>
              ...
              <div class="col-md-6">
              <label>GW/CS</label>
              <input class="form-control"  onchange="cbm()"name="GW_CS" id="prices3" type="text" readonly>
              </div>
              <div class="col-md-6">
              <label>Grosswight</label>
              <input class="form-control" onchange="cbm()" name="Gross_weight" id="prices4" type="text" readonly>
              </div>
              <div class="col-md-6">
              <label>Total CMB</label>
              <input class="form-control" id="total_cmb"  name="total_cmb"  type="text" readonly>
              </div>
              <div class="col-md-6">
              <label>Total GW</label>
              <input class="form-control" id="total_gw"  name="total_gw" type="text" readonly>
              </div>
              <div class="col-md-6">
              <label>Util 20 cmb</label>
              <input class="form-control" id="util_20cmb"  name="util_20cmb" type="text" readonly>
              </div>
              <div class="col-md-6">
              <label>Util 40 cmb</label>
              <input class="form-control" id="util_40cmb"  name="util_40cmb" type="text" readonly>
              </div>            
              <div class="col-md-6">
              <label>Util 20 gw</label>
              <input class="form-control" id="util_20gw"  name="util_20gw" type="text" readonly>
              </div>
              <div class="col-md-6">
              <label>Util 40 gw</label>
              <input class="form-control" id="util_40gw"  name="util_40gw" type="text" readonly>
              </div>
