    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{ asset('backend/dist/img/1.jpg') }}" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview {{Request::is('container','containeradd','container/{id}/edit',
        'destination','destinationadd','destination/{id}/edit',
        'vendor','vendoradd','vendor/{id}/edit',
        'category','categoryadd','category/{id}/edit'
        )?'active':''}}">
          <a href="#">
        ...
        <li class="treeview active">
          <a href="#">
            <i class="fa fa-table"></i> <span>Shipment Template</span>
            <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
          </a>
        ...
        <li class="treeview active">
          <a href="#">
            <i class="fa fa-table"></i> <span>Breackdown & Codekist</span>
            <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
          </a>
