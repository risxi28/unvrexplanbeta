        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <form action="{{url('vendor/update')}}" method="POST">
             {{ csrf_field() }}
            <input class="hidden" name="id" type="text" placeholder="Vendor Name" value="{{$p->id_vendor}}"> 
             <label>Vendor Name</label>
              <input class="form-control" name="vendor_name" type="text" placeholder="Vendor Name" value="{{$p->vendor_name}}">
